...
- `155 тестов` (18 файлов, включая integration/pdf-renderer.test.ts, log-service.test.ts, text-extractor.test.ts, document-store.test.ts), build prod ~1.9MB (pdfjs-dist v4.10.38 + mammoth), tsc clean
